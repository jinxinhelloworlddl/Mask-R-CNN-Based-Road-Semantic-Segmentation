...
def train(model,args_dataset,epochs,lr):#,config):
    ...
    dataset_train.load_road(args_dataset, "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = RoadDataset()
    dataset_val.load_road(args_dataset, "val")
    dataset_val.prepare()
...
def detect_and_show(model, image_path=None, video_path=None): 
    ...
    if image_path:
        ...
        filter_classs_names = ['roadmark', 'car']
    ...
    while(capture.isOpened()):
        ...
        if ret:
            ...
            frame = display_instances(
                frame, r['rois'], r['masks'], r['class_ids'], model.class_names, r['scores']
            )
...
class RoadDataset(Dataset):
    def load_road(self, dataset_dir, subset):
        ...
        """
        # Add classes.
        self.add_class("road", 1, "roadmark")
        self.add_class("road", 2, "car")
        if not dataset_dir:
            return
...
----------------------------------------------------------
Powered by
  __  __           _      _____         _____ _   _ _   _ 
 |  \/  |         | |    |  __ \       / ____| \ | | \ | |
 | \  / | __ _ ___| | __ | |__) |_____| |    |  \| |  \| |
 | |\/| |/ _` / __| |/ / |  _  /______| |    | . ` | . ` |
 | |  | | (_| \__ \   <  | | \ \      | |____| |\  | |\  |
 |_|  |_|\__,_|___/_|\_\ |_|  \_\      \_____|_| \_|_| \_|
 Li Xin & Jin Xin
 adviser: Dr. Tan Jen Hong
 ---------------------------------------------------------
 '''
print(welcome)    